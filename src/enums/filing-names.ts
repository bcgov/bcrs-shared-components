export enum FilingNames {
  ...
  AMEND_RECEIVER = 'Amend Receiver Information',
  APPOINT_LIQUIDATOR = 'Notice of Appointment of Liquidator',
  APPOINT_RECEIVER = 'Notice of Appointment of Receiver or Receiver Manager',
  ANNUAL_REPORT = 'Annual Report',
  CEASE_LIQUIDATOR = 'Notice of Ceasing to Act as Liquidator',
  CEASE_RECEIVER = 'Notice of Ceasing to Act as Receiver or Receiver Manager',
  CHANGE_OF_ADDRESS = 'Address Change',
  CHANGE_OF_ADDRESS_LIQUIDATOR = 'Notice of Change of Address of Liquidator and/or Liquidation Records Office',
  CHANGE_OF_ADDRESS_RECEIVER = 'Notice of Receiver Change of Address Filing',
  ...
  INTENT_TO_LIQUIDATE = 'Statement of Intent to Liquidate',
