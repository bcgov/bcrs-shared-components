<template>
  <v-card flat id="effective-date-time-box">
    <v-radio-group column class="pt-0 mt-0" v-model="effectiveDateType">
      ...
      <v-radio label="A date and time in the future" :value=EffectiveDateTypes.FUTURE_EFFECTIVE />
    </v-radio-group>
...
import { DatePicker } from '@/components' // NB: local component
import { DateMixin } from '@/mixins' // NB: local mixins
