...
export default class CorrectNameOptions extends Vue {
  ...
  @Prop() readonly correctionNameChoices!: Array<NameChangeOptions>

  get getBusinessId (): string {
    return null
  }
  get getEntityType (): CorpTypeCd {
    return null
  }
  get getNameRequest (): NameRequestIF {
    return null
  }
  set setNameRequest (val: NameRequestIF) {
    // do nothing
  }
  ...
  /** Inform parent that name correction is cancelled. */
  @Emit('cancel')
