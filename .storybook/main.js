...
module.exports = {
  ...
  webpackFinal: async (config, { configType }) => {
    ...
    config.resolve.alias['@bcrs-shared-components/mixins'] = path.resolve(__dirname, '../') + '/src/mixins';
    config.resolve.alias['@bcrs-shared-components/types'] = path.resolve(__dirname, '../') + '/src/types';
